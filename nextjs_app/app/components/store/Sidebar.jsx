    ...
    <div className='h-full w-full flex flex-col justify-between'>
      <div className="">
        {navData.map((item, index) => {
          return (
            <Link href={item.route} className="flex items-center space-x-2 w-full px-7 py-1 mt-1 hover:bg-light-violet" key={index}>
...
function Sidebar() {
  return (
    <Sheet>
      ...
      <SheetContent side="left" className='lg:hidden gap-3 p-0 h-full flex flex-col border-r border-black bg-extra-light-violet'>
        <SheetHeader>
          <SideBarHeader/>
        </SheetHeader>
        <SideBarContent />
